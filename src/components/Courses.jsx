      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          >
            ...
            <span className="text-zinc-300 text-xs font-mono tracking-widest uppercase">// Continuous Learning</span>
          </motion.div>
                ...
                <div>
                  <div className="flex justify-between items-center mb-6">
                    <motion.span 
                      ...
                      className="text-zinc-200 font-mono text-sm font-bold tracking-wider uppercase bg-white/5 px-3 py-1 rounded-md border border-white/5"
                    >
                      {item.period}
                    </motion.span>
